...
(13,1,1,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxLCJ1c2VyX25hbWUiOiJhZG1pbiIsInBob25lIjoiMTU4eHh4eHg5MjkiLCJleHAiOjE2NjU3MDAxMjYsIm5iZiI6MTY2NTY3MTMxNn0.TucJqR8BU6cdupvAnZsZJc41JRcbacUW8FISsGrS-pY','login','[*]',0,'127.0.0.1','2022-10-13 22:28:46','2022-10-13 22:28:46','2022-10-14 06:28:46'),
(14,1,1,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxLCJ1c2VyX25hbWUiOiJhZG1pbiIsInBob25lIjoiMTU4eHh4eHg5MjkiLCJleHAiOjE2NjU3MDAyMzAsIm5iZiI6MTY2NTY3MTQyMH0.cxvbxmbefpJU-MVX2ErVZ56JchSFOjhOW7P00snqHT0','login','[*]',0,'127.0.0.1','2022-10-13 22:30:30','2022-10-13 22:30:30','2022-10-14 06:30:30');
...
CREATE TABLE `tb_auth_casbin_rule` (
  ...
  UNIQUE KEY `idx_vp01` (`ptype`,`v0`,`v1`,`v2`)
...
(404,'p','36','/admin/employees/list*','GET','','','',979,'',''),
(405,'p','36','/admin/train_timetable/list*','GET','','','',980,'','');
...
CREATE TABLE `tb_auth_post_mount_has_menu` (
  ...
  `updated_at` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_post_menu` (`fr_auth_orgnization_post_id`,`fr_auth_system_menu_id`)
...
(382,36,53,1,'','2022-06-09 11:55:18','2022-06-09 11:55:18'),
(383,36,54,1,'','2022-10-13 22:43:18','2022-10-13 22:43:18'),
(384,36,55,1,'','2022-10-13 22:43:18','2022-10-13 22:43:18'),
(385,36,56,1,'','2022-10-13 22:43:18','2022-10-13 22:43:18');
...
CREATE TABLE `tb_auth_post_mount_has_menu_button` (
  ...
  `updated_at` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_menu_button` (`fr_auth_post_mount_has_menu_id`,`fr_auth_button_cn_en_id`)
...
(979,384,4,1,'','2022-10-13 22:43:18','2022-10-13 22:43:18'),
(980,385,4,1,'','2022-10-13 22:43:18','2022-10-13 22:43:18');
...
CREATE TABLE `tb_auth_system_menu` (
  ...
  `is_out_page` tinyint(1) DEFAULT 0 COMMENT '是否为外部页面,0=否;1=是,主要用于区分页面是被view-router渲染还是被oframe渲染',
...
insert  into `tb_auth_system_menu`(`id`,`fid`,`icon`,`title`,`url`,`name`,`path`,`component`,`is_out_page`,`sort`,`node_level`,`path_info`,`status`,`remark`,`created_at`,`updated_at`) values 
(2,0,'Setting','系统配置','','system-setting','/system_setting','',0,9950,1,'0,2',1,'父级菜单的sort值必须 > 子级菜单值','2020-12-01 16:02:05','2020-12-01 16:02:05'),
(3,2,'','系统菜单','','system_menu','system_menu','views/system-setting/sys_menu.vue',0,9949,2,'0,2,3',1,'子级菜单值只要保证 < 父级菜单的sort值即可,子级菜单互相之间没有限制','2020-12-01 16:07:03','2021-03-20 13:24:34'),
(4,2,'','组织机构','','organization','organization','views/system-setting/organization.vue',0,9948,2,'0,2,4',1,'','2020-12-01 16:29:21','2021-03-23 14:27:36'),
(5,2,'','岗位成员','','post_members','post_members','views/system-setting/org_members.vue',0,9947,2,'0,2,5',1,'','2020-12-01 16:36:43','2021-03-23 14:30:51'),
(6,2,'','用户管理','','user','user','views/system-setting/user.vue',0,9946,2,'0,2,6',1,'','2020-12-01 16:37:03','2021-03-23 14:31:15'),
(7,2,'','权限分配','','org_post_auth_assignment','org_post_auth_assignment','views/system-setting/auth_assignment.vue',0,9944,2,'0,2,7',1,'','2020-12-01 16:42:08','2020-12-01 16:42:08'),
(8,2,'','权限分析','','org_post_auth_analysis','org_post_auth_analysis','views/system-setting/auth_analysis.vue',0,9943,2,'0,2,8',1,'','2020-12-01 16:44:39','2020-12-01 16:44:39'),
(10,2,'','按钮设置','','button_cn_en','button_cn_en','views/system-setting/button_cn_en.vue',0,9945,2,'0,2,10',1,'','2021-01-27 16:12:19','2021-03-23 14:26:48'),
(39,2,'','公共权限','','common_auth','common_auth','disabled',0,9942,2,'0,2,39',0,'本条菜单用于绑定公共权限，分配给顶级组织机构节点，供其他节点继承，前台不可见','2021-03-10 17:43:01','2022-01-19 14:23:06'),
(41,0,'Grid','基础数据','','data-dictionary','/data_dictionary','',0,9900,1,'0,41',1,'父级菜单的sort值必须 > 子级菜单值','2021-03-20 15:00:52','2021-03-23 14:28:59'),
(42,41,'','省份城市','','province_city','province_city','views/data-dictionary/province_city.vue',0,9899,2,'0,41,42',1,'','2021-03-20 15:01:52','2021-03-23 14:31:53'),
(53,0,'HomeFilled','动态首页','','dynamic_index','','views/home/index.vue',0,9990,1,'0,53',1,'','2022-06-09 11:51:47','2022-06-09 11:51:47'),
(54,0,'Management','统计报表','','report','','',0,2000,1,'0,54',1,'','2022-10-13 22:40:11','2022-10-13 22:40:11'),
(55,54,'','员工小报表','','employees','','views/statistical-report/employees.vue',1,1999,2,'0,54,55',1,'','2022-10-13 22:42:18','2022-10-13 23:42:53'),
(56,54,'','列车时刻表','','train_timetable','','views/statistical-report/train_timetable.vue',1,1998,2,'0,54,56',1,'','2022-10-13 22:43:09','2022-10-13 22:43:09');
...
(92,55,4,'/admin/employees/list*','GET',1,'该接口主要是显示查询按钮,报表请求的接口在前端配置文件','2022-10-13 22:42:18','2022-10-13 23:42:53'),
(93,56,4,'/admin/train_timetable/list*','GET',1,'该接口主要是显示查询按钮,报表请求的接口在前端配置文件','2022-10-13 22:43:09','2022-10-13 22:43:09');
...
(1,'admin','ff1e2a0591fde5214b52942be87be566','管理员','158xxxxx929','/public/storage/uploaded/2021_03/d023d70fff24d7bb237d27cc7c00c11f.png',0,0,1,'管理员账号','2021-03-16 13:17:48','127.0.0.1',118,'2021-03-19 00:07:15','2021-03-22 00:09:41'),
(3,'boshi','188bda0c10088d7c2e6d7c00592679e7','博士','158xxxxx929','/public/storage/uploaded/2022_06/351b9dece2fb1021a4402b9e40a0ffce.jpg0',321,0,1,'更新资料9527','2020-12-01 14:07:44','127.0.0.1',1,'2020-12-01 14:07:44','2022-06-04 15:46:19');
